...
class Module extends Element_Pack_Module_Base {
	...
	// public function widget_threed_text_before_render($widget) {
	// 	$settings = $widget->get_settings_for_display();

	// 	if (isset($settings['ep_threed_text_active']) && ($settings['ep_threed_text_active'] === 'yes')) {
	// 		wp_enqueue_script('ztext');
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script('ztext-js', BDTEP_ASSETS_URL . 'vendor/js/ztext' . $suffix . '.js', ['jquery'], '0.0.2', true);
	}
