<?php
	...
	class Brand_Grid extends Module_Base {
		...
		public function get_icon() {
			return 'bdt-wi-brand-grid bdt-new';
		}
		...
		protected function register_controls() {
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .bdt-brand-grid' => 'grid-template-columns: repeat({{SIZE}}, 1fr);',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .bdt-brand-grid' => 'grid-column-gap: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .bdt-brand-grid' => 'grid-row-gap: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'prefix_class' => 'bdt-ep-brand-grid-icon--',
				]
			);
		...
		protected function render() {
			...
			$this->add_render_attribute( 'brand-grid', 'class', 'bdt-brand-grid' );
				...
				$this->add_render_attribute(
					[
						'website-link' => [
							...
							'target' => isset($item['link']['is_external']) ? '_blank' : '_self'
						]
					], '', '', true
				);
