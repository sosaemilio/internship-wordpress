...
class Skin_Ekip extends Elementor_Skin_Base {
	...
	public function register_ekip_style_controls(Module_Base $widget) {
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'gradient' ],
				'selector' => '{{WRAPPER}} .bdt-member.bdt-member-skin-ekip .bdt-member-skin-ekip-overlay',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-member.bdt-member-skin-ekip .bdt-member-skin-ekip-overlay' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	public function render() {
		...
		$this->parent->add_render_attribute( 'skin-ekip', 'class', ['bdt-member', 'bdt-member-skin-ekip', 'bdt-transition-toggle', 'bdt-image-mask'] );
		...
		<div <?php echo $this->parent->get_render_attribute_string( 'skin-ekip' ); ?>>
				...
				<div class="bdt-member-skin-ekip-overlay">
