...
function element_pack_post_pagination($wp_query) {
    ...
    // add_filter(
    //     'found_posts',
    //     function () use ($total_posts, $wp_query) {
    //     if (!empty($query->query_vars['offset_to_fix'])) {
    //     $offset = $query->query_vars['offset_to_fix'];
    //     if ($query->is_home()) {
    ...
    //     }
    // );
    // add_filter('found_posts', [$wp_query, 'element_pack_adjust_offset_pagination'], 1, 2);
...
function element_pack_adjust_offset_pagination($found_posts, $query) {
    if (!empty($query->query_vars['offset_to_fix'])) {
        $offset = $query->query_vars['offset_to_fix'];
        if ($query->is_home()) {
            return $found_posts - $offset;
