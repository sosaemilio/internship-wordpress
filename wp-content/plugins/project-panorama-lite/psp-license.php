...
function edd_panorama_license_page() {
	...
	<div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
			...
			<a href="edit.php?post_type=psp_projects&page=panorama-license&tab=psp_other" class="nav-tab <?php if($active_tab == "psp_other") { echo 'nav-tab-active'; } ?>"><?php _e('Pro Features','psp_projects'); ?></a>
		</h2>
		...
		<form method="post" action="options.php">
			...
			<div id="psp_other" class="psp-settings-tab <?php if($active_tab == 'psp_other') { echo "psp-settings-tab-active"; } ?>">

				<h2><?php esc_html_e( 'Pro Features', 'psp_projects' ); ?></h2>

				<div style="border: 1px solid #ddd; background: #fff; display: inline-block;">
					<img style="display: block; margin: 0;" src="<?php echo PROJECT_PANORAMA_URI; ?>/assets/images/promo/panorama-dashboard.png">
				</div>
